...
contract CrowdfundingEjer2 {
   ...
   using SafeMath for uint256;
    ...
    // Generar evento cuando creemos un proyecto
        ...
        event ProjectEmpezado(
            address direccionContrato, 
            address creadorProyecto,
    ...
    // Funcion para crear proyectos
        ...
        function crearProjecto( 
            ...
            uint duracionEnDias, 
            uint montoARecaudar) external {

            uint recaudarHasta = now.add(duracionEnDias.mul(1 days));

            Project nuevoProjecto = new Project(
                msg.sender, 
                titulo, 
                descripcion, 
                recaudarHasta, 
            ...
            emit ProjectEmpezado( 
                address(nuevoProjecto), 
                msg.sender, 
                titulo, 
                descripcion, 
                recaudarHasta,
...
contract Project {
    ...
    // constructor
        ...
        constructor(
            ...
            uint fechaLimiteRecaudacion, 
            uint montoObjetivo) public {
